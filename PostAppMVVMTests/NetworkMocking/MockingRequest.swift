...
extension URLSession {
    static var mockedResponsesOnly: URLSession {
        ...
        configuration.protocolClasses = [MockingRequest.self, RequestBlocking.self]
...
final class MockingRequest: URLProtocol {
    ...
    override func startLoading() {
        if let mock = MockingRequest.mock(for: request),
            let url = request.url,
